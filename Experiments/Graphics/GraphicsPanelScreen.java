...
public class GraphicsPanelScreen extends JPanel implements MouseListener, MouseMotionListener
{
   ...
   public static void createAndShowGUI()
   {
      ...
      JPanel gamePanel = new GraphicsPanelScreen();
	...
	public void mouseMoved(MouseEvent e)
{
	...
	points.add(e.getLocationOnScreen().toString());	
}
