...
public class chessGameReplayer
{
    ...
    public static void main(String[] args)
    {
        ...
        path = "/Users/gbancroft25/Desktop/Chess games/tempgame.game";
    ...
    public static void printList(Piece[][] sss)
    {
    ...
    public static Piece[][] doMove(ArrayList<String> moves, int moveNum, Piece[][] board)
    {
